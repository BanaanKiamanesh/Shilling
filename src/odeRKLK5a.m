function [Time, Y] = odeRKLK5a(f, TSpan, Y0, h)
    ...
    % Method Params
    a2 = 1.0 / 2.0;
    a3 = 1.0 / 2.0 - 1.0 / 10.0 * sqrt(5);
    a4 = 1.0 / 2.0;
    a5 = 1.0 / 2.0 + 1.0 / 10.0 * sqrt(5);

    b21 =  1.0 / 2.0;
    b31 =  1.0 / 5.0;
    b32 =  3.0 / 10.0 - 1.0 / 10.0 * sqrt(5);
    b41 =  1.0 / 4.0;
    b42 =  1.0 / 4.0;
    b51 =  1.0 / 20.0 - 1.0 / 20.0 * sqrt(5);
    b52 = -1.0 / 5.0;
    b53 =  1.0 / 4.0 + 3.0 / 20.0 * sqrt(5);
    b54 =  2.0 / 5.0;
    b61 =  1.0 / 4.0 * sqrt(5) - 1.0 / 4.0;
    b62 =  1.0 / 2.0 * sqrt(5) - 1.0 / 2.0;
    b63 =  5.0 / 4.0 - 1.0 / 4.0 * sqrt(5);
    b64 = -2.0;
    b65 =  5.0 / 2.0 - 1.0 / 2.0 * sqrt(5);
